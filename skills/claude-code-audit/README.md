# Claude Code Audit for Claude Code

**Knowledge skill.** Audit and fix your AI coding setup: health check for the whole rig.
...
Live preview: [donatassimkus.com/ai-skills/claude-code-audit](https://donatassimkus.com/ai-skills/claude-code-audit)
