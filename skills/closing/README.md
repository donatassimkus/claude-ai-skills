# Closing for Claude Code

**Knowledge skill.** Handle objections and run discovery calls that actually close.
...
Live preview: [donatassimkus.com/ai-skills/closing](https://donatassimkus.com/ai-skills/closing)
