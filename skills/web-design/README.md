# Web Design for Claude Code

**Knowledge skill.** Direction, composition, and components for a page that doesn't look generic.
...
Live preview: [donatassimkus.com/ai-skills/web-design](https://donatassimkus.com/ai-skills/web-design)
