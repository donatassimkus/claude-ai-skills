...
| Stage | Name | Headcount | Your Role | Main Constraint | Graduate By |
|---|---|---|---|---|---|
| 0 | Improvise | 1 | Explorer | No product yet | Make something people want |
| 1 | Monetize | 1 | Starter | Business makes no money | Make first sale |
| 2 | Advertise | 1 + freelancers | Doer | Customer flow is inconsistent | Consistent quality + regular new customers |
| 3 | Stabilize | 1–4 | Trainer | Too much work for one person | Get real help |
| 4 | Prioritize | 5–9 | Manager | Serving too many customer types | Niche down to ideal customer |
| 5 | Productize | 10–19 | Director | Low LTV, one product | Build second premium product |
| 6 | Optimize | 20–49 | Leader | Everything inefficient | Do things better, not more |
| 7 | Categorize | 50–99 | Executive | Every system overwhelmed | Triage and organize |
| 8 | Specialize | 100–249 | President | No one can know everything | Build specialist teams |
| 9 | Capitalize | 250–500 | Chairman | Growth plateaued | Make a big bet |
...
**How to deploy:**
1. Share with team leaders.
2. Each leader grades their team: Energy (1–10), Engagement (1–10), Exploration (1–10).
3. Focus on the single lowest-scoring area first.
4. Let the team propose how to improve it — they will own what they designed.
...
| Category | Description | Raise Range |
|---|---|---|
| Not meeting criteria | Regular performance, no exceptional results | 1–3% |
| Consistent and reliable | Meets expectations, dependable contributor | 4–5% |
| High performance / added responsibilities | Consistently exceeds, takes on more | 5–10% |
| Promotion / new skills / major scope change | New role or dramatically expanded responsibilities | 10–20% |
...
1. Evaluate against the 4 categories.
2. Communicate the decision with reasoning, not just the outcome.
3. If declining: state what would qualify them and when to revisit.
...
| Headcount | Role | What You Actually Do |
|---|---|---|
| 1 | Starter/Doer | Everything — product, sales, delivery, admin |
| 1–4 | Trainer | Teach others to do what you do |
| 5–9 | Manager | Manage people, not tasks |
| 10–19 | Director | Manage managers, not individual contributors |
| 20–49 | Leader | Set strategy, build culture, clear bottlenecks |
| 50–99 | Executive | Run the leadership team, not the departments |
| 100–249 | President | Allocate capital, set direction, hire for critical roles |
| 250–500 | Chairman | Own vision, deploy capital, make the big bets |
...
1. Find your current stage by headcount.
2. Confirm the main constraint matches the stage description.
3. Verify it is an operational constraint — not a product or market problem.
4. Apply only the solutions for your current stage.
5. Define your graduation milestone. Know what "done" looks like before you start.
...
- [ ] Single biggest operational constraint named
- [ ] Working on the constraint, not the loudest complaint

**Team:**
- [ ] Org chart exists — everyone knows who they report to
- [ ] Everyone has a clear, written job description
- [ ] New hires have a documented onboarding process

**Systems:**
- [ ] Monday Hour One deployed for weekly planning
- [ ] Gametape Review running weekly (once sales and CS exist)
- [ ] 5 Star Service standards in place (once customer-facing team exists)
- [ ] High Performance Communication graded, lowest area being improved
- [ ] Pay Increase Framework documented and shared with team

**Finance:**
- [ ] Books reconciled monthly
- [ ] Budget exists and is tracked
- [ ] Payroll processed correctly and on time
...
|---|---|---|
| Communication | They do not know what to do | Clarify expectations. Restate the outcome, deadline, and standard. |
| Training | They do not know how to do it | Teach the skill. Pair them with someone who can. Provide resources. |
| Motivation | They do not want to do it | Find out why. Misaligned role, burnout, or mismatched incentives. Address the root cause. |
| Circumstances | Something external is blocking them | Remove the obstacle. Tools, access, dependencies, personal situation. |
...
1. **Document:** Write down exactly how you do the task. Step by step checklist. Include what "done" looks like.
2. **Demonstrate:** Do the task while they watch. Record yourself doing it so the recording becomes permanent training material.
3. **Duplicate:** They do the task while you watch. Correct in real time. Repeat until output matches the standard.
...
**How to apply:**
1. Decide at the start of each week which blocks are Maker and which are Manager.
2. Schedule all meetings into Manager blocks. Protect Maker blocks completely.
3. If your calendar has no Maker blocks, you are not building. You are only reacting.

---

## Key Principles

1. The constraint at each stage is predictable. Diagnose first, prescribe second.
2. The founder's job changes completely every 2–3 stages. Clinging to old roles creates the bottleneck.
3. Document before you hire. Undocumented processes break when handed to someone new.
4. Train before you hire more. Adding headcount to a broken process makes it worse faster.
5. Promote from within first. Hire outside only for skills the team genuinely does not have.
6. Teams do not scale through talent alone. Systems and communication infrastructure determine whether talented people compound or cancel each other out.
7. Transparency in pay prevents compounding resentment. Publish criteria, not individual numbers.
8. One delivery quality metric tracked consistently beats ten metrics tracked inconsistently.
...
| Revenue Stage | What to Focus On | Why |
|---|---|---|
| **0 to 6 figures** | One product, one audience, one channel | Validation. Prove the core offer works before diversifying. |
| **6 to 7 figures** | Deepen the core product. Improve quality and repeatability. Add one upsell. | At this stage, quality improvements generate more revenue than new products. |
| **7 to 8 figures** | Add a second product sold to existing customers. | Acquisition is working. LTV is now the constraint. |
| **8 figures+** | Add second acquisition channel. Build second audience segment. | Core channel is maxed or expensive. Need diversification to grow. |
...
1. List everything your business already produces as a side effect of delivering the core offer
2. Ask: who else would pay for this? Why is it valuable to them even if it's routine to you?
3. The bar is not that it's perfect — it just needs to be genuinely useful to someone outside
