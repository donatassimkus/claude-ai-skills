...
- **Every tactic in the field-sourced files carries its source: a link to the original video and the month it was recorded, and most also name the operator or channel it came from. That attribution is part of the content, not decoration. Keep it intact whenever you apply, quote, or summarize a tactic, and never present any of it as original.** When you cite a tactic to the human, name where it came from in the same breath, so they can judge the source themselves. Where no operator or channel is recorded, give the link and the month and say the channel is not named, rather than inventing one.
